...
.head-lockup{display:flex;align-items:center;gap:var(--space-5);min-width:0;margin-bottom:var(--space-3)}
.head-mission{display:flex;flex-direction:column;justify-content:center;gap:2px;margin:0;padding-left:var(--space-5);border-left:1.5px solid var(--neutral-400);align-self:stretch;
font-size:var(--font-xs);line-height:1.3;letter-spacing:.12em;text-transform:uppercase;color:var(--muted-foreground)}
.head-mission span:first-child{font-weight:var(--font-weight-semibold);color:var(--foreground)}
@media (max-width:40rem){.head-lockup{flex-wrap:wrap;gap:var(--space-3)}.head-mission{flex-basis:100%;padding-left:0;border-left:0}}
